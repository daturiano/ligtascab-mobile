...
export default function FeedbackModal({
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // Invalidate driver ratings and review lists
      queryClient.invalidateQueries({ queryKey: ['driver_rating', rideDetails.driver_details.id] });
      queryClient.invalidateQueries({
        queryKey: ['driver_reviews', rideDetails.driver_details.id],
      });
            ...
            <Box
              ...
              {showThankYou ? (
                <Box paddingVertical="l" alignItems="center" gap="m">
                  ...
                  <Text variant="subheader" textAlign="center" color="primary">
                    Success!
                  </Text>
                  ...
                  <Box width="100%">
                    <TextInput
                      style={[
                        styles.input,
                        {
                          borderColor: theme.colors.mutedLighter,
